...
# ==================================================================
rule()
H('Part 2 — Ali’s suggestions: cutting down the text', 16, DARK, before=18, after=10)
...
para('This isn’t a copy edit — it reverses a specific, documented pedagogy decision: "the 1800RESPECT / '
     ...
     'confirmation before it happens — the same weight as the multi-select decision in Part 1, not something '
     'to fold in quietly alongside the wording trims below.')
...
quote('Ali', 'To have only one screen title to identify each screen (currently there are a couple of titles for '
             ...
             'what does Orion do?")')
para('Reading this as: keep the step-progress indicator (the dots + "Step X of 10", since that’s '
...
para('Note: this is the intro line above the options — it sits alongside whatever gets decided for the '
     'multi-select + colour-coded outcomes in Part 1, Screen 06.', italic=True, color=GREY, before=2)
